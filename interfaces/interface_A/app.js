...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      interests: [{ id: 'interest_ponies', label: 'Pony' }, { id: 'interest_polo', label: 'Polo' }, { id: 'interest_dough', label: 'Pasta' }, { id: 'interest_snails', label: 'Lumache' }, { id: 'interest_balls', label: 'Sfere' }, { id: 'interest_postits', label: 'Post-it' }, { id: 'interest_faucets', label: 'Rubinetti' }, { id: 'interest_enveloppes', label: 'Buste' }, { id: 'interest_cables', label: 'Cavi' }, { id: 'interest_questions', label: 'Domande' }, { id: 'interest_squares', label: 'Quadrati' }, { id: 'interest_purple', label: 'Viola' }, { id: 'interest_cotton', label: 'Cotone' }, { id: 'interest_drywall', label: 'Cartongesso' }, { id: 'interest_closets', label: 'Armadi' }, { id: 'interest_tires', label: 'Pneumatici' }, { id: 'interest_windows', label: 'Finestre' }, { id: 'interest_bonjovi', label: 'Bon Jovi' }, { id: 'interest_cinnamon', label: 'Cannella' }, { id: 'interest_unselectall', label: 'Uselect all' }]
    };
  }
});

},{"./template.html":3,"vue/dist/vue.min.js":92}],3:[function(require,module,exports){
module.exports = "<div class=avatar-and-interests-page><ui-avatar-and-interests :page=page :num-pages=numPages ref=avatar-and-interests-form></ui-avatar-and-interests><div class=avatar-and-interests-page__buttons-row><div class=avatar-and-interests-page__buttons><div class=\"align align--fluid align--fixed align--gutter-md\"><div class=align__cell><ui-button color=white kind=stroked fluid @click=onClickNext>Avanti</ui-button></div><div class=align__cell><ui-button color=green fluid @click=onClickCancel>Annulla</ui-button></div></div></div></div></div>";
...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      ...
      avatarImage: null,
      interests: [{ id: 'interest_ponies', label: 'Pony', value: true }, { id: 'interest_polo', label: 'Polo', value: true }, { id: 'interest_dough', label: 'Pasta', value: true }, { id: 'interest_snails', label: 'Lumache', value: true }, { id: 'interest_balls', label: 'Sfere', value: true }, { id: 'interest_postits', label: 'Post-it', value: true }, { id: 'interest_faucets', label: 'Rubinetti', value: true }, { id: 'interest_enveloppes', label: 'Buste', value: true }, { id: 'interest_cables', label: 'Cavi', value: true }, { id: 'interest_questions', label: 'Domande', value: true }, { id: 'interest_squares', label: 'Quadrati', value: true }, { id: 'interest_purple', label: 'Viola', value: true }, { id: 'interest_cotton', label: 'Cotone', value: true }, { id: 'interest_drywall', label: 'Cartongesso', value: true }, { id: 'interest_closets', label: 'Armadi', value: true }, { id: 'interest_tires', label: 'Pneumatici', value: true }, { id: 'interest_windows', label: 'Finestre', value: true },
      // { id: 'interest_bonjovi', label: 'Bon Jovi' },
      { id: 'interest_selectall', label: 'Seleziona tutti', action: 'selectall', value: true }, { id: 'interest_cinnamon', label: 'Cannella', value: true }, { id: 'interest_unselectall', label: 'Deseleziona tutti', action: 'unselectall', value: true }]
    };
  }
});

},{"../../utils/FileDialog":74,"../../utils/download":78,"./template.html":5,"vue/dist/vue.min.js":92}],5:[function(require,module,exports){
module.exports = "<div class=avatar-and-interests><div class=avatar-and-interests__form><ui-page-indicator :page=page :num-pages=numPages></ui-page-indicator><div class=\"avatar-and-interests__section avatar-and-interests__avatar-section\"><div class=\"align align--fluid align--even\"><div class=align__cell><div class=avatar-and-interests__avatar-box><ui-spinner class=avatar-and-interests__spinner></ui-spinner><div class=avatar-and-interests__avatar-image v-if=validation.hasAvatar :style=\"'background-image: url('+avatarImage+')'\"></div></div></div><div class=\"align__cell avatar-and-interests__avatar-upload-cell\"><h2 class=avatar-and-interests__title>Questo/a sono io</h2><p class=avatar-and-interests__text>Per completare il tuo profilo, <a @click=onClickUpload class=avatar-and-interests__upload-button>carica</a> qualsiasi immagine.</p><div class=\"\"><ui-button @click=onClickDownloadImage class=\"align__cell avatar-and-interests__avatar-upload-button\">Scarica immagine</ui-button></div></div></div></div><div class=\"avatar-and-interests__section avatar-and-interests__interests-section\"><h2 class=avatar-and-interests__title>Scegli 3 interessi</h2><div class=avatar-and-interests__interests-list><div class=avatar-and-interests__interests-list__item v-for=\"interest in interests\"><div><ui-checkbox :ref=interest.id :inputid=interest.id v-model=interest.value @input=\"changedInterestCheckbox(interest, $event)\" small=1></ui-checkbox><span>{{interest.label}}</span></div></div></div></div><div v-if=errorsShown class=avatar-and-interests__errors><ul class=avatar-and-interests__errors-list><li v-if=!validation.hasAvatar class=avatar-and-interests__error>Si prega di caricare una foto.</li><li v-if=!validation.has3Interests class=avatar-and-interests__error>Si prega di scegliere 3 interessi.</li></ul></div></div></div>";
...
module.exports = "<div class=cookies><div class=\"align align--fluid\"><div class=align__cell><p class=cookies__message>Questo sito utilizza i cookie, è un problema per te?</p></div><div class=align__cell><div class=\"align align--gutter-md u-right\"><div class=align__cell><ui-button @click=hide color=transparent>Direi di no</ui-button></div><div class=align__cell><ui-button class=cookies__button color=white>Si</ui-button></div></div></div></div></div>";
...
module.exports = "<div class=end-screen><h1 class=end-screen__title>REGISTRAZIONE COMPLETATA CON SUCCESSO</h1><img class=end-screen__image src=images/carlton-dancing.gif alt=\"Carlton Dancing\"></div>";
...
module.exports = "<div class=help-form :class=\"{ 'is-hidden': closed }\" ref=helpform><div class=help-form__container @click=clickform><h2 class=help-form__title>Come possiamo aiutare?</h2><button @click=onUp class=\"button button--solid button--blue help-form__close-button\"><span class=\"icon icon-chevron-up\"></span></button><textarea ref=commentTextArea v-model=comment @input=onchange class=help-form__text-area></textarea><div class=\"align align--fluid align--even\"><div class=\"align__cell u-left\"><a @click=onsend class=help-form__help-button>Aiuto</a></div><div class=\"align__cell u-right\"><button @click=onclose class=\"button button--solid button--blue help-form__send-to-bottom-button\"><span class=highlight>Manda</span><br><span class=discrete>giù</span></button></div></div><div v-if=showResponse class=help-form__response>Attendere prego, ci sono {{numWaiting}} persone in fila.</div></div></div>";
...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      ...
      emailExtensions: [{ label: 'altro', data: '' }, '.org', '.co.uk', '.net', '.gov', '.de', '.fr', '.nl', '.com', '.be', '.jpg'],
      emailError: false,
      passwordError: false,
...
module.exports = "<div :class=className><div class=modal__box><div class=modal__content><slot></slot><span v-if=isClosable class=modal__close-copyright><span @click=close>&#169;hiudi</span> {{year}}</span></div><span @click=toggleFullscreen class=modal__fullscreen></span></div></div>";
...
var rules = [{
  ...
  message: 'La password deve contenere almeno 1 lettera della tua email.',
  visible: true,
  check: function check(loginData) {
  ...
  message: 'La password può contenere almeno 1 carattere cirillico.',
  visible: true,
  check: function check(loginData) {
...
module.exports = "<div class=password-check><div class=password-check__password-correct v-if=passwordCorrect>La tua password non è insicura</div><div class=password-check__password-rule v-for=\"rule in rules\" v-if=rule.visible>{{ rule.message }}</div></div>";
...
var validators = [newEmptyStringValidator('firstname', 'Nome non valido'), {
  validate: function validate(data, errors) {
    var title = data.title;

    if (!title) {
      errors.push('Nessun appellativo selezionato');
    }
  }
...
// Birth date only
{
  ...
  validate: function validate(data, errors) {
    ...
    if (calcAge !== age) {
      errors.push('Età e data di nascita non corrispondono');
    }
  }
}, {
  // Check gender & title
  validate: function validate(data, errors) {
    ...
    if (title) {
      ...
      var isMr = title === 'sig';
      if (isMr !== gender) {
        errors.push('Genere e appellativo non coincidono');
      }
    }
  }
}];
...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      ...
      form: {
        rows: [{
          cols: [{ label: 'Nome', key: 'firstname' }, { label: 'CAP', key: 'zip' }]
        }, {
          cols: [{ label: 'Appellativo', key: 'title', type: 'dropdown', items: ['Sig', 'Sig.ra'], emptyValue: "Scegli un appellativo" }, { label: 'Città', key: 'city' }]
        }, {
          cols: [{ label: 'Cognome', key: 'surname' }, { label: 'Paese', key: 'country', type: 'country' }]
        }, {
          cols: [{ label: 'Via', key: 'street' }, { label: 'Numero civico', key: 'number', type: 'stepper', minimum: 1 }]
        }, {
          cols: [{ label: 'Data di nascita', key: 'birthdate', type: 'date' }, { label: 'Età', type: 'slider', key: 'age', className: 'age-property' }]
        }, {
          cols: [{ label: 'Genere', type: 'gender', key: 'gender' }]
        }]
      }
    };
  }
...
module.exports = "<ui-modal-template><h2 class=\"title title--center\">Affrettati, il tempo stringe!</h2><ui-timer color=gray center></ui-timer><ui-button v-if=locked @click=unlock color=red center>Sblocca</ui-button><ui-button v-else @click=lock color=green center>Blocca</ui-button></ui-modal-template>";
