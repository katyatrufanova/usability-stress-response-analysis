...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      interests: [{ id: 'interest_ponies', label: 'Social media' }, { id: 'interest_polo', label: 'Sports' }, { id: 'interest_dough', label: 'Games' }, { id: 'interest_snails', label: 'Friends' }, { id: 'interest_balls', label: 'Family' }, { id: 'interest_postits', label: 'Pets' }, { id: 'interest_faucets', label: 'Learning' }, { id: 'interest_enveloppes', label: 'Movies' }, { id: 'interest_cables', label: 'TV Series' }, { id: 'interest_questions', label: 'Books' }, { id: 'interest_squares', label: 'Travel' }, { id: 'interest_purple', label: 'Purple' }, { id: 'interest_cotton', label: 'Cotton' }, { id: 'interest_drywall', label: 'Spirituality' }, { id: 'interest_closets', label: 'Fashion' }, { id: 'interest_tires', label: 'Cars' }, { id: 'interest_windows', label: 'Design' }, { id: 'interest_mullets', label: 'Mullets' }, { id: 'interest_bonjovi', label: 'Bon Jovi' }
      //, { id: 'interest_cinnamon', label: 'Cinnamon' }
      //, { id: 'interest_unselectall', label: 'Unselect all' }
      ]
    };
  }
});
...
module.exports = "<div class=avatar-and-interests-page><ui-avatar-and-interests :page=page :num-pages=numPages ref=avatar-and-interests-form></ui-avatar-and-interests><div class=avatar-and-interests-page__buttons-row><div class=avatar-and-interests-page__buttons><div class=\"align align--fluid align--fixed align--gutter-md\"><div class=align__cell><ui-button color=white kind=stroked fluid @click=onClickCancel>Annulla</ui-button></div><div class=align__cell><ui-button color=green fluid @click=onClickNext>Avanti</ui-button></div></div></div></div></div>";
...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      ...
      avatarImage: null,
      interests: [{ id: 'interest_ponies', label: 'Social Media', value: false }, { id: 'interest_polo', label: 'Sport', value: false }, { id: 'interest_dough', label: 'Videogiochi', value: false }, { id: 'interest_snails', label: 'Amici', value: false }, { id: 'interest_balls', label: 'Famiglia', value: false }, { id: 'interest_postits', label: 'Animali', value: false }, { id: 'interest_faucets', label: 'Studio', value: false }, { id: 'interest_enveloppes', label: 'Film', value: false }, { id: 'interest_cables', label: 'Serie TV', value: false }, { id: 'interest_questions', label: 'Libri', value: false }, { id: 'interest_squares', label: 'Viaggi', value: false }, { id: 'interest_purple', label: 'Religione', value: false }, { id: 'interest_cotton', label: 'Moda', value: false }, { id: 'interest_drywall', label: 'Auto', value: false }, { id: 'interest_closets', label: 'Design', value: false }, { id: 'interest_tires', label: 'Arte', value: false }
      //, { id: 'interest_windows', label: 'Windows', value: false },
      // { id: 'interest_bonjovi', label: 'Bon Jovi' },
      //{ id: 'interest_selectall', label: 'Select all', action: 'selectall', value: true }, 
      //{ id: 'interest_mullets', label: 'Mullets', value: false }, { id: 'interest_cinnamon', label: 'Cinnamon', value: false }, 
      //{ id: 'interest_unselectall', label: 'Unselect all', action: 'unselectall', value: true }
      ]
    };
  }
});
...
var prefix = 'images/captcha-galleries/buses/bus';
exports.default = {
  title: 'Seleziona tutti gli autobus',
...
exports.default = _vue2.default.extend({
  ...
  methods: {
    ...
    getRandomGallery: function getRandomGallery() {
      ...
      return galleries['check'];
    },
    getCaptchaRowClass: function getCaptchaRowClass(row) {
      var suffix = row % 2 === 0 ? 'captcha-gallery__row-check' : 'captcha-gallery__row-image';

      return 'captcha-gallery__row ' + suffix;
    },
    getCaptchaCellClass: function getCaptchaCellClass(row, column) {
      var suffix = row % 2 === 0 ? 'captcha-gallery__cell-check' : 'captcha-gallery__cell-image';
  ...
  computed: {
    ...
    numRows: function numRows() {
      return 3; // TODO: compute from current gallery
    }
  },
  data: function data() {
    return {
...
module.exports = "<div class=captcha-gallery><ui-page-indicator :page=page :num-pages=numPages></ui-page-indicator><h2>Quasi fatto! Ora abbiamo solo bisogno della prova che sei umano.</h2><h3>{{gallery.title}}</h3><div ref=table-container class=captcha-gallery__container><div class=captcha-gallery__table><div :class=getCaptchaRowClass(r) v-for=\"r in ((numRows*2))\"><div :class=\"getCaptchaCellClass(r, c)\" v-for=\"c in numCols\" v-if=\"r%2 !== 0\"><div class=captcha-gallery__image-container :style=\"getBackgroundImageStyle(calcCellIndex(c, r, 0))\"></div></div><div :class=\"getCaptchaCellClass(r, c)\" v-for=\"c in numCols\" v-if=\"r%2 === 0\"><ui-checkbox :ref=\"getCheckRefName(calcCellIndex(c, r, 0))\" :value=\"getCheckValue(calcCellIndex(c, r, 1))\" @change=\"onChangedCheck(calcCellIndex(c, r, 0), $event)\"></ui-checkbox></div></div></div></div><div class=captcha-gallery__button-container><ui-button @click=onClickValidate>Conferma</ui-button></div></div>";
...
exports.default = _dropdown2.default.extend({
  ...
  methods: {
    ...
    getNoneSelectedContent: function getNoneSelectedContent() {
      return this.emptyValue || 'Scegli un paese';
    },
...
var MONTHS = [{ label: 'Gennaio', value: 0 }, { label: 'Febbraio', value: 1 }, { label: 'Marzo', value: 2 }, { label: 'Aprile', value: 3 }, { label: 'Maggio', value: 4 }, { label: 'Giugno', value: 5 }, { label: 'Luglio', value: 6 }, { label: 'Agosto', value: 7 }, { label: 'Settembre', value: 8 }, { label: 'Ottobre', value: 9 }, { label: 'Novembre', value: 10 }, { label: 'Dicembre', value: 11 }];
...
module.exports = "<div class=end-screen><h1 class=end-screen__title>REGISTRAZIONE COMPLETATA CON SUCCESSO</h1>";
...
exports.default = _vue2.default.extend({
  ...
  methods: {
    ...
    onFocus: function onFocus() {
      ...
      if (internalLowerCase.startsWith(placeholderLowerCase) || placeholderLowerCase.startsWith(internalLowerCase)) {
        this.internal = '';
      }
...
module.exports = "<input @focus=onFocus @blur=onBlur :class=className :placeholder=placeholder tabindex=-1 :type=type v-model=internal>";
...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      ...
      emailExtensions: [{ label: 'seleziona', data: '' }, '.org', '.it', '.co.uk', '.net', '.gov', '.de', '.fr', '.nl', '.com'],
      emailError: false,
      passwordError: false,
...
module.exports = "<div class=login-form><div class=login-form__container-copy-1></div><div class=login-form__container-copy-2></div><div class=login-form__container><form><div class=\"login-form__section login-form__fields\"><ui-page-indicator :page=page :num-pages=numPages></ui-page-indicator><div class=login-form__field-row><ui-input ref=input-password @input=onChangePassword :class=passwordClass type=text tabindex=-1 placeholder=\"Password\" v-model=loginData.password></ui-input></div><div class=\"align align--fluid align--gutter-sm login-form__field-row\"><div class=align__cell><ui-input ref=input-email-name placeholder=\"email\" :class=emailClass v-model=loginData.emailName></ui-input></div><div class=align__cell>@</div><div class=align__cell><ui-input ref=input-email-domain placeholder=domain v-model=loginData.emailDomain :class=emailClass></ui-input></div><div class=align__cell><ui-dropdown :class=emailDropdownClass ref=dropdown-email-ext :items=emailExtensions :selected=selectedEmailExtensionIndex @change=onChangeEmailExtension></ui-dropdown></div></div></div><div class=login-form__section><ui-checkbox inputid=accept-terms-conditions v-model=loginData.dontAcceptTermsConditions></ui-checkbox><a class=login-form__terms-conditions @click=onClickTermsAndConditions>Accetto <span class=login-form__terms-conditions-underline>Termini & Condizioni</span></a></div><div v-if=termsAndConditionsError class=login-form__terms-conditions-error>Non dimenticarti di accettare termini e condizioni</div><div class=\"login-form__section align align--fluid align--even\"><div class=\"align__cell button-container__secondary\"><a class=button--secondary @click=cancel>Annulla</a></div><div class=\"align__cell button-container__primary\"><ui-button @click=onClickNext() fluid>Avanti</ui-button></div><div class=\"align__cell button-container__secondary\"><a @click=reset class=\"button--secondary u-right\">Ripristina</a></div></div></form></div></div>";
...
module.exports = "<div :class=className><div class=modal__box><div class=modal__content><slot></slot></div><span @click=close class=modal__fullscreen></span></div></div>";
...
var rules = [{
  message: 'La password deve avere almeno 10 caratteri.',
  visible: true,
...
module.exports = "<div class=password-check><div class=password-check__password-rule v-for=\"rule in rules\" v-if=rule.visible>{{ rule.message }}</div></div>";
  ...
  return {
    validate: function validate(data, errors) {
      ...
      if (value && value.toLowerCase) {
        ...
        if (valueLc.startsWith && valueLc.startsWith('placeholder') || valueLc === 'Type here') {
...
}, newEmptyStringValidator('surname', 'Cognome non valido'), newEmptyStringValidator('street', 'Via non valida'), newEmptyStringValidator('zip', 'CAP non valido'), newEmptyStringValidator('city', 'Città non valida'), {
  // country
  validate: function validate(data, errors) {
    var country = data.country;

    if (!country) {
      errors.push('Nessun paese selezionato');
    }
  }
},
// Birth date only
...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      ...
      form: {
        rows: [{
          cols: [{ label: 'Nome', key: 'firstname' }, { label: 'Cognome', key: 'surname' }]
        }, {
          cols: [{ label: 'Genere', type: 'gender', key: 'gender' }, { label: 'Data di nascita', key: 'birthdate', type: 'date' }]
        }, {
          cols: [{ label: 'Paese', key: 'country', type: 'country' }, { label: 'Città', key: 'city' }]
        }, {
          cols: [{ label: 'Via', key: 'street' }, { label: 'Numero civico', key: 'number' }]
        }, {
          cols: [{ label: 'CAP', key: 'zip' }]
        }]
      }
    };
  }
...
module.exports = "<div class=personal-details><div class=personal-details__content><div class=personal-details__form><ui-page-indicator :page=page :num-pages=numPages></ui-page-indicator><h3>Dati personali</h3><div class=personal-details__form-table><div :class=getRowClass(row) v-for=\"row in form.rows\"><div :colspan=col.colspan :class=getCellClass(col) v-for=\"col in row.cols\"><div class=personal-details__property-item-table><div class=personal-details__property-item-tr-row><div class=personal-details__td-label>{{col.label}}</div><div class=personal-details__td-value><div v-if=\"col.type==='slider'\"><ui-slider :precision=0 :value=0 :maximum=200 @change=\"onChangeField(col, $event)\"></ui-slider></div><ui-dropdown @change=\"onChangeField(col, $event)\" v-else-if=\"col.type==='dropdown'\" :items=col.items :empty-value=col.emptyValue></ui-dropdown><ui-country-dropdown @change=\"onChangeField(col, $event)\" v-else-if=\"col.type==='country'\"></ui-country-dropdown><ui-numeric-stepper @change=\"onChangeField(col, $event)\" v-else-if=\"col.type==='stepper'\" :minimum=col.minimum :maximum=col.maximum></ui-numeric-stepper><ui-toggle-buttons @change=\"onChangeField(col, $event)\" v-else-if=\"col.type==='gender'\" left-option=Maschile right-option=Femminile></ui-toggle-buttons><ui-date-dropdowns @change=\"onChangeField(col, $event)\" :sort-months=true v-else-if=\"col.type==='date'\"></ui-date-dropdowns><ui-input @blur=\"onChangeField(col, $event)\" v-else></ui-input></div></div></div></div></div></div></div><div class=personal-details__bottom-button-row><div class=personal-details__bottom-button-container><div class=\"align align--gutter-md\"><div class=align__cell><ui-button color=white kind=stroked @click=onClickCancel>Annulla</ui-button></div><div class=align__cell><ui-button color=green @click=onClickNext>Avanti</ui-button></div></div></div></div></div></div>";
